/*=========================================================================
  ...
  Module:    $RCSfile: itkTensorWithFaFileWriter.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkTensorWithFaFileWriter_h
#define __itkTensorWithFaFileWriter_h
 ...
 */
template<typename T>
class ITK_EXPORT TensorWithFaFileWriter :
    public
...
//  typedef Image<Vector<typename TInputImage::PixelType::RealValueType,6>,3 > TOutputImage;
  ...
  typedef TensorWithFaFileWriter  Self;
...
protected:
  TensorWithFaFileWriter() {};
  virtual ~TensorWithFaFileWriter() {};

private:
  TensorWithFaFileWriter(const Self&); //purposely not implemented
...
#include "itkTensorWithFaFileWriter.txx"
#endif
