...
void GetImageType(std::string fileName, itk::ImageIOBase::IOPixelType & pixelType,
...
template <class DWIPixelType>
int process(params list)
{
  ...
  // Filter the image
  typedef itk::SphericalHarmonicsInterpolationFilter<DiffusionImageType,
                                                     DiffusionImageType> SphericalHarmonicsInterpolationFilterType;
  typename SphericalHarmonicsInterpolationFilterType::Pointer shFilter =
    SphericalHarmonicsInterpolationFilterType::New();
