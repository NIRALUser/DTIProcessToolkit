/*=========================================================================
  ...
  Module:    $RCSfile: itkDiffusionTensor3DReconstructionNonlinearImageFilter.txx,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkDiffusionTensor3DReconstructionNonlinearImageFilter_txx
#define __itkDiffusionTensor3DReconstructionNonlinearImageFilter_txx
...
DiffusionTensor3DReconstructionNonlinearImageFilter< TReferenceImagePixelType,
...
template< class TReferenceImagePixelType, 
          class TGradientImagePixelType, class TTensorType >
void DiffusionTensor3DReconstructionNonlinearImageFilter< TReferenceImagePixelType,
  TGradientImagePixelType, TTensorType >
 ...
 //   while( !git.IsAtEnd() )
      while( !git.IsAtEnd() && !tit.IsAtEnd() )
      {
       ...
       if( (b0 != 0) && (b0 >= m_Threshold) )
         {
         typedef ExponentialLeastSquaresFunction<ReferencePixelType> FittingFunctionType;
         ...
         vnl_vector<double> vnlt(tensor.GetDataPointer(),6);

//         std::cout << "Diagnose outcome" << std::endl;
//         std::cout << vnlt << std::endl;
         if(!optimizer.minimize(vnlt))
           {
           std::cerr << "Error in optimization!" << std::endl;
           }
//         std::cout << vnlt << std::endl;

//         std::cout << optimizer.get_g_tolerance() << std::endl;
//         optimizer.diagnose_outcome(std::cout);
