...
if( EXTENSION_SUPERBUILD_BINARY_DIR )
  if(APPLE)
    install(FILES ${CMAKE_CURRENT_SOURCE_DIR}/InstallApple/lib DESTINATION ${CLI_RUNTIME_OUTPUT_DIRECTORY}/..)
    install(FILES ${CMAKE_CURRENT_SOURCE_DIR}/InstallApple/Frameworks DESTINATION ${CLI_RUNTIME_OUTPUT_DIRECTORY}/..)
    install(FILES ${CMAKE_CURRENT_SOURCE_DIR}/InstallApple/AppleCreateLinkLibs.sh DESTINATION ${CLI_RUNTIME_OUTPUT_DIRECTORY}/../share)
  endif(APPLE)
